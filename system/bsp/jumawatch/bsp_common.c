...
static void SPIx_MspInit(SPI_HandleTypeDef *hspi)
{
  ...
  if(hspi->Instance==DISCOVERY_SPIx){
      /* Enable SPIx clock */
      DISCOVERY_SPIx_CLK_ENABLE();

      /* Enable DISCOVERY_SPI GPIO clock */
      DISCOVERY_SPIx_MISO_MOSI_GPIO_CLK_ENABLE();
      DISCOVERY_SPIx_SCK_GPIO_CLK_ENABLE();
      DISCOVERY_SPIx_CS_GPIO_CLK_ENABLE();

      /* MOSI*/    
      GPIO_InitStructure.Pin    = DISCOVERY_SPIx_MOSI_PIN;
      GPIO_InitStructure.Mode   = GPIO_MODE_AF_PP;
      GPIO_InitStructure.Pull   = GPIO_NOPULL;
      GPIO_InitStructure.Speed  = GPIO_SPEED_HIGH;
      GPIO_InitStructure.Alternate = DISCOVERY_SPIx_AF;
      HAL_GPIO_Init(DISCOVERY_SPIx_MISO_MOSI_GPIO_PORT, &GPIO_InitStructure);
      /*sck*/
      GPIO_InitStructure.Pin   = DISCOVERY_SPIx_SCK_PIN;
      GPIO_InitStructure.Pull   = GPIO_PULLDOWN;
      HAL_GPIO_Init(DISCOVERY_SPIx_SCK_GPIO_PORT, &GPIO_InitStructure);
      /*cs*/
      GPIO_InitStructure.Pin   = DISCOVERY_SPIx_CS_PIN;
      GPIO_InitStructure.Pull   = GPIO_PULLUP;
      GPIO_InitStructure.Mode   = GPIO_MODE_OUTPUT_PP;
      HAL_GPIO_Init(DISCOVERY_SPIx_CS_GPIO_PORT, &GPIO_InitStructure);
      HAL_GPIO_WritePin(DISCOVERY_SPIx_CS_GPIO_PORT, DISCOVERY_SPIx_CS_PIN, GPIO_PIN_SET);
 }
...
void LCD_IO_WriteData(uint8_t RegValue) 
{
	uint8_t tmp,RegValue1 ;
//	tmp = (RegValue << 7) & 0x80;
//	RegValue = ((RegValue >> 1) & (~0x80)) | (0x80);
...
//  LCD_CS_HIGH();
//		
//		RegValue1 |= (RegValue  << 7)& 0x80;
//		RegValue1 |= (RegValue  << 6)& 0x40;
//		RegValue1 |= (RegValue  << 5)& 0x20;
//		RegValue1 |= (RegValue  << 4)& 0x10;
//		RegValue1 |= (RegValue  << 3)& 0x08;
//		RegValue1 |= (RegValue  << 2)& 0x04;
//		RegValue1 |= (RegValue  << 1)& 0x02;
//		RegValue1 |= (RegValue  << 0)& 0x01;
		LCD_CS_LOW();
		HAL_GPIO_WritePin(DISCOVERY_SPIx_MISO_MOSI_GPIO_PORT,DISCOVERY_SPIx_MOSI_PIN,0x01);
		HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x01);
		HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x00);
	
		for(tmp = 0; tmp < 8; tmp++){
				HAL_GPIO_WritePin(DISCOVERY_SPIx_MISO_MOSI_GPIO_PORT,DISCOVERY_SPIx_MOSI_PIN,(RegValue >> (7-tmp))&0x01);
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x01);
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x00);
		}
		LCD_CS_HIGH();
...
//  /* Deselect: Chip Select high */
//  LCD_CS_HIGH();
//		RegValue1 |= (Reg  << 7)& 0x80;
//		RegValue1 |= (Reg  << 6)& 0x40;
//		RegValue1 |= (Reg  << 5)& 0x20;
//		RegValue1 |= (Reg  << 4)& 0x10;
//		RegValue1 |= (Reg  << 3)& 0x08;
//		RegValue1 |= (Reg  << 2)& 0x04;
//		RegValue1 |= (Reg  << 1)& 0x02;
//		RegValue1 |= (Reg  << 0)& 0x01;
		LCD_CS_LOW();
		HAL_GPIO_WritePin(DISCOVERY_SPIx_MISO_MOSI_GPIO_PORT,DISCOVERY_SPIx_MOSI_PIN,0x00);
		HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x01);
		HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x00);
	
		for(tmp = 0; tmp < 8; tmp++){
				HAL_GPIO_WritePin(DISCOVERY_SPIx_MISO_MOSI_GPIO_PORT,DISCOVERY_SPIx_MOSI_PIN,(Reg >> (7-tmp))&0x01);
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x01);
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x00);
		}
		LCD_CS_HIGH();
...
//  
	...
	delay_abit();
		...
		for(tmp2 = 0; tmp2 < 8; tmp2++){
				HAL_GPIO_WritePin(DISCOVERY_SPIx_MISO_MOSI_GPIO_PORT,DISCOVERY_SPIx_MOSI_PIN,(RegValue >> (7-tmp2))&0x01);
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x01);
				delay_abit();
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x00);
		}
		for(tmp2 = 0; tmp2 < 8*ReadSize; tmp2++){
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x01);
			
				tmp1 = HAL_GPIO_ReadPin(DISCOVERY_SPIx_MISO_MOSI_GPIO_PORT,DISCOVERY_SPIx_MOSI_PIN);
				readvalue |= (uint32_t)tmp1 << (8*ReadSize-tmp2-1);
				tmp1 = 0;
				delay_abit();
				HAL_GPIO_WritePin(DISCOVERY_SPIx_SCK_GPIO_PORT,DISCOVERY_SPIx_SCK_PIN,0x00);
		}
